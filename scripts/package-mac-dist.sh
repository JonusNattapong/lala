...
# Output:
# - dist/Lala.app
# - dist/Lala-<version>.zip
# - dist/Lala-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.lala.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/Lala.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Lala-$VERSION.zip"
DMG="$ROOT_DIR/dist/Lala-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Lala-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Lala-$VERSION.dSYM.zip"
