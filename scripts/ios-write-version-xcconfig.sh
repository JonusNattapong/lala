...
- LALA_GATEWAY_VERSION = exact package.json version
- LALA_MARKETING_VERSION = short iOS/App Store version
- LALA_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
LALA_GATEWAY_VERSION = ${PACKAGE_VERSION}
LALA_MARKETING_VERSION = ${MARKETING_VERSION}
LALA_BUILD_VERSION = ${BUILD_NUMBER}
EOF
