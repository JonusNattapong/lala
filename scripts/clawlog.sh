...
show_usage() {
    cat << EOF
clawlog - Lala Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Lala logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Lala logs flow through the macOS unified log (subsystem: ai.lala).
