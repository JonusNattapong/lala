import type { LalaConfig, PluginRuntime, ResolvedLineAccount } from "lala/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: LalaConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: LalaConfig; accountId: string }): Promise<{
