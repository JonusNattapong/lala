...
const lineConfigBase = createScopedChannelConfigBase<ResolvedLineAccount, LalaConfig>({
  sectionKey: "line",
...
const resolveLineDmPolicy = createScopedDmSecurityResolver<ResolvedLineAccount>({
  ...
  approveHint: "lala pairing approve line <code>",
...
export const linePlugin: ChannelPlugin<ResolvedLineAccount> = {
  ...
  pairing: {
    ...
    notifyApproval: async ({ cfg, id }) => {
      ...
      await line.pushMessageLine(id, "Lala: your access has been approved.", {
  ...
  gateway: {
    ...
    logoutAccount: async ({ accountId, cfg }) => {
      ...
      const nextCfg = { ...cfg } as LalaConfig;
      const lineConfig = (cfg.channels?.line ?? {}) as LineConfig;
