...
Lala treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.lala/settings/voicewake.json`

Shape:

```json
{ "triggers": ["lala", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
