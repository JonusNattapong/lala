...
read_when:
  - You are building a Lala plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (lala.plugin.json)

Every plugin **must** ship a `lala.plugin.json` file in the **plugin root**.
Lala uses this manifest to validate configuration **without executing plugin
