...
Set plugin-wide defaults in `~/.lala/lala.json`:
...
- Artifacts are stored under the temp subfolder: `$TMPDIR/lala-diffs`.
...
1. `browser.executablePath` in Lala config.
2. Environment variables:
   - `LALA_BROWSER_EXECUTABLE_PATH`
