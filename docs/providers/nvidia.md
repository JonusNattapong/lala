---
summary: "Use NVIDIA's OpenAI-compatible API in Lala"
read_when:
  - You want to use NVIDIA models in Lala
...
lala onboard --auth-choice skip
lala models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
