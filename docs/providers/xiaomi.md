---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Lala"
read_when:
  - You want Xiaomi MiMo models in Lala
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Lala uses
