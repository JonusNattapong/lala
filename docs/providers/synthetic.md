---
summary: "Use Synthetic's Anthropic-compatible API in Lala"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Lala registers it as the
...
Note: Lala's Anthropic client appends `/v1` to the base URL, so use
