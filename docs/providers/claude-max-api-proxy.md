...
You can point Lala at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Lala
...
- [Anthropic provider](/providers/anthropic) - Native Lala integration with Claude setup-token or API keys
