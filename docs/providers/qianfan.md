---
summary: "Use Qianfan's unified API to access many models in Lala"
read_when:
...
3. Lala installed on your system
...
4. Copy the API key for use with Lala

## CLI setup

```bash
lala onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Lala Configuration](/gateway/configuration)
