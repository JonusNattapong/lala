...
ditto -c -k --sequesterRsrc --keepParent dist/Lala.app dist/Lala-2026.3.11.zip

# Optional: build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/Lala.app dist/Lala-2026.3.11.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/Lala.app.dSYM dist/Lala-2026.3.11.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/Lala-2026.3.11.zip https://raw.githubusercontent.com/lala/lala/main/appcast.xml
```
...
- Upload `Lala-2026.3.11.zip` (and `Lala-2026.3.11.dSYM.zip`) to the GitHub release for tag `v2026.3.11`.
