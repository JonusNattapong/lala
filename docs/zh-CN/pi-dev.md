...
状态存储在 Lala 状态目录下。默认为 `~/.lala`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.lala.ai/testing
- https://docs.lala.ai/start/getting-started
