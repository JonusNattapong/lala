...
将 Lala 部署到生产服务器的推荐方式是通过 **[lala-ansible](https://github.com/lala/lala-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/lala/lala-ansible](https://github.com/lala/lala-ansible)**
>
...
- [安全架构](https://github.com/lala/lala-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/lala/lala-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/lala/lala-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [lala-ansible](https://github.com/lala/lala-ansible) — 完整部署指南
