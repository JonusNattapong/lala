---
summary: "First-run onboarding flow for Lala (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Lala">
...
<Step title="CLI">
  ...
  The app can install the global `lala` CLI via npm/pnpm so terminal
