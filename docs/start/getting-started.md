...
<Info>
Fastest chat: open the Control UI (no channel setup needed). Run `lala dashboard`
and chat in the browser, or open `http://127.0.0.1:18789/` on the
<Tooltip headline="Gateway host" tip="The machine running the Lala gateway service.">gateway host</Tooltip>.
...
<Steps>
  <Step title="Install Lala (recommended)">
    <Tabs>
