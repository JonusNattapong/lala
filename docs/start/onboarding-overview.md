---
summary: "Overview of Lala onboarding options and flows"
read_when:
...
Lala supports multiple onboarding paths depending on where the Gateway runs
...
- [`lala onboard` command](/cli/onboard)

## macOS app onboarding

Use the Lala app when you want a fully guided setup on macOS. Docs:
