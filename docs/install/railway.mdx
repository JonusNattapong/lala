...
Deploy Lala on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/lala` — Control UI
...
- `LALA_STATE_DIR=/data/.lala` (recommended)
- `LALA_WORKSPACE_DIR=/data/workspace` (recommended)
- `LALA_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Lala state + workspace so you can migrate to another host without losing config or memory.
