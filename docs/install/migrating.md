---
summary: "Move (migrate) a Lala install from one machine to another"
read_when:
  - You are moving Lala to a new laptop/server
  - You want to preserve sessions, auth, and channel logins (WhatsApp, etc.)
title: "Migration Guide"
---

# Migrating Lala to a new machine

This guide migrates a Lala Gateway from one machine to another **without redoing onboarding**.
...
- `~/.lala/workspace/` (recommended workspace)
...
- Gateway configuration (`lala.json`)
...
If you have multiple profiles/state dirs (e.g. `~/.lala-main`, `~/.lala-work`), archive each.

### Step 1 — Install Lala on the new machine

On the **new** machine, install the CLI (and Node if needed):

- See: [Install](/install)

At this stage, it’s OK if onboarding creates a fresh `~/.lala/` — you will overwrite it in the next step.
...
- Hidden directories were included (e.g. `.lala/`)
...
### Footgun: copying only `lala.json`
...
- `lala status` shows the gateway running
...
- [Where does Lala store its data?](/help/faq#where-does-lala-store-its-data)
