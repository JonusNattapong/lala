...
Lala ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Lala also aligns
the install method:
...
When you switch channels with `lala update`, Lala also syncs plugin sources:
