---
summary: "Where Lala loads environment variables and the precedence order"
read_when:
...
Lala pulls environment variables from multiple sources. The rule is **never override existing values**.
...
Lala supports two env-driven patterns:
