...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.LALA_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.LALA_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.LALA_SERVICE_MARKER = originalServiceMarker;
    }
  });
