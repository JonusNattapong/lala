...
export function isAcpEnabledByPolicy(cfg: LalaConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: LalaConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: LalaConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: LalaConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: LalaConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: LalaConfig, agentId: string): boolean {
