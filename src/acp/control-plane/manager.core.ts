...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: LalaConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: LalaConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: LalaConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: LalaConfig }): Promise<void> {
