...
describe("agent components", () => {
  const createCfg = (): LalaConfig => ({}) as LalaConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/lala-sessions-test.json");
  });
