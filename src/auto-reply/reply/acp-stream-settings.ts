...
function resolveAcpStreamCoalesceIdleMs(cfg: LalaConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: LalaConfig): number {
...
export function resolveAcpProjectionSettings(cfg: LalaConfig): AcpProjectionSettings {
