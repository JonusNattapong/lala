...
function resolveMentionPatterns(cfg: LalaConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: LalaConfig | undefined, agentId?: string): RegExp[] {
