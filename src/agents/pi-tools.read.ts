...
function resolveAdaptiveReadMaxBytes(options?: LalaReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createLalaReadTool(base, {
...
export function createLalaReadTool(
  base: AnyAgentTool,
  options?: LalaReadToolOptions,
): AnyAgentTool {
