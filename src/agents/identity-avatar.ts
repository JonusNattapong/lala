...
function resolveAvatarSource(cfg: LalaConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: LalaConfig, agentId: string): AgentAvatarResolution {
