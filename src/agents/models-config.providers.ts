...
type ModelsConfig = NonNullable<LalaConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier Lala docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // Lala keeps auth in auth-profiles and resolves runtime availability from that store.
