...
export function resolveSubagentToolPolicy(cfg?: LalaConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: LalaConfig["tools"]): string[] | undefined {
