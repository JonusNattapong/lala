...
export const DEFAULT_SANDBOX_IMAGE = "lala-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "lala-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "lala-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "lala-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "lala-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "lala-sandbox-browser";
