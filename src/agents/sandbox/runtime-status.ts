...
function resolveMainSessionKeyForSandbox(params: { cfg?: LalaConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: LalaConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`lala sandbox explain --session ${runtime.sessionKey}`)}`);
