...
function resolveWatchPaths(workspaceDir: string, config?: LalaConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: LalaConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: LalaConfig }) {
