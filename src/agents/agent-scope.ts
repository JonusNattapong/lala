...
type AgentEntry = NonNullable<NonNullable<LalaConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: LalaConfig): AgentEntry[] {
...
export function listAgentIds(cfg: LalaConfig): string[] {
...
export function resolveDefaultAgentId(cfg: LalaConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: LalaConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentSkillsFilter(cfg: LalaConfig, agentId: string): string[] | undefined {
...
export function resolveAgentModelPrimary(cfg: LalaConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: LalaConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentIdsByWorkspacePath(cfg: LalaConfig, workspacePath: string): string[] {
...
export function resolveAgentDir(cfg: LalaConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
