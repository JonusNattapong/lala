...
const CLEANUP_STATE_KEY = Symbol.for("lala.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("lala.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("lala.sessionWriteLockWatchdogState");
