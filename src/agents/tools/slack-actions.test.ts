...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): LalaConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: LalaConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: LalaConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
