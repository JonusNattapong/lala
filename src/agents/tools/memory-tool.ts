...
function resolveMemoryToolContext(options: { config?: LalaConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: LalaConfig): MemoryCitationsMode {
