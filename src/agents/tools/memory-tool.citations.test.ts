...
function asLalaConfig(config: Partial<LalaConfig>): LalaConfig {
  return config as LalaConfig;
}

function createToolConfig() {
  return asLalaConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: LalaConfig = createToolConfig()) {
