...
async function resolveContext(config: LalaConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): LalaConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
