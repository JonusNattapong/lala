    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["lala directory self --channel slack", "Show the connected account identity."],
          [
            'lala directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["lala directory groups list --channel discord", "List available groups/channels."],
          [
            "lala directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.lala.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
