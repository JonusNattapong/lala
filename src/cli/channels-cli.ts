    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["lala channels list", "List configured channels and auth profiles."],
          ["lala channels status --probe", "Run channel status checks and probes."],
          [
            "lala channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["lala channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.lala.ai/cli/channels",
        )}\n`,
    );
