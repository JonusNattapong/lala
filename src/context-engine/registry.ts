...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("lala.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: LalaConfig): Promise<ContextEngine> {
