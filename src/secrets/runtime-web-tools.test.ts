...
async function runRuntimeWebTools(params: { config: LalaConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: LalaConfig, provider: ProviderUnderTest): unknown {
  if (provider === "brave") {
