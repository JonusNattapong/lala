...
export function listAuthProfileStorePaths(config: LalaConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: LalaConfig, stateDir: string): string[] {
