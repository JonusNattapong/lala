...
function resolveResolutionLimits(config: LalaConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: LalaConfig): SecretProviderConfig {
