...
function resolveAnthropicDefaultAuthMode(cfg: LalaConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: LalaConfig): LalaConfig {
...
export function applyTalkApiKey(config: LalaConfig): LalaConfig {
...
export function applyTalkConfigNormalization(config: LalaConfig): LalaConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: LalaConfig): LalaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: LalaConfig): LalaConfig {
...
export function applyLoggingDefaults(cfg: LalaConfig): LalaConfig {
...
export function applyContextPruningDefaults(cfg: LalaConfig): LalaConfig {
...
export function applyCompactionDefaults(cfg: LalaConfig): LalaConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
