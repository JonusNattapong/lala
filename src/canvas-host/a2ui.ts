...
export const A2UI_PATH = "/__lala__/a2ui";

export const CANVAS_HOST_PATH = "/__lala__/canvas";

export const CANVAS_WS_PATH = "/__lala__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.lalaCanvasA2UIAction.postMessage(...)
  // - Android: window.lalaCanvasA2UIAction.postMessage(...)
  const handlerNames = ["lalaCanvasA2UIAction"];
  ...
  globalThis.Lala = globalThis.Lala ?? {};
  globalThis.Lala.postMessage = postToNode;
  globalThis.Lala.sendUserAction = sendUserAction;
  globalThis.lalaPostMessage = postToNode;
  globalThis.lalaSendUserAction = sendUserAction;
