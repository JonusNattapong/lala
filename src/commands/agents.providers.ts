...
function resolveDefaultAccountId(cfg: LalaConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: LalaConfig): boolean {
...
export function summarizeBindings(cfg: LalaConfig, bindings: AgentBinding[]): string[] {
