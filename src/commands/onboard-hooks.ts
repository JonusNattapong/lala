...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.lala.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("lala hooks list")}`,
      `  ${formatCliCommand("lala hooks enable <name>")}`,
      `  ${formatCliCommand("lala hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
