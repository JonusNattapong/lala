...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: LalaConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: LalaConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: LalaConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: LalaConfig; accountId?: string | null }) => number | undefined;
