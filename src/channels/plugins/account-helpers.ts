...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: LalaConfig): string | undefined {
  ...
  function listAccountIds(cfg: LalaConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: LalaConfig): string {
