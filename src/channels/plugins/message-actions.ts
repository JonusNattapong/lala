...
export function listChannelMessageActions(cfg: LalaConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: LalaConfig): boolean {
...
export function supportsChannelMessageCards(cfg: LalaConfig): boolean {
