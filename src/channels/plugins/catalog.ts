...
import { discoverLalaPlugins } from "../../plugins/discovery.js";
import type { LalaPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, LalaPackageManifest>>;

const ENV_CATALOG_PATHS = ["LALA_PLUGIN_CATALOG_PATHS", "LALA_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<LalaPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: LalaPackageManifest;
