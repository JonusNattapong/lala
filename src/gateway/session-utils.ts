...
import { type LalaConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: LalaConfig): string[] {
...
export function listAgentsForGateway(cfg: LalaConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: LalaConfig): string {
...
function resolveSessionStoreAgentId(cfg: LalaConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: LalaConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: LalaConfig): GatewaySessionsDefaults {
