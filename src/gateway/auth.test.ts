...
describe("gateway auth", () => {
  ...
  it("resolves token/password from LALA gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          LALA_GATEWAY_TOKEN: "env-token",
          LALA_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides LALA_GATEWAY_PASSWORD", () => {
