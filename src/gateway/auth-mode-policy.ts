...
export function hasAmbiguousGatewayAuthModeConfig(cfg: LalaConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: LalaConfig): void {
