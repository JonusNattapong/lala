...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.LALA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: LalaConfig): string[] {
...
export function listTelegramAccountIds(cfg: LalaConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: LalaConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/JonusNattapong/lala/issues/30673
...
export function listEnabledTelegramAccounts(cfg: LalaConfig): ResolvedTelegramAccount[] {
