...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("lala");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "lala");
