...
export function buildServiceEnvironment(params: {
  ...
  const windowsTaskName = resolveGatewayWindowsTaskName(profile);
  return {
...
export function buildNodeServiceEnvironment(params: {
  ...
  const systemdUnit = resolveNodeSystemdServiceName();
  const windowsTaskName = resolveNodeWindowsTaskName();
  return {
    ...buildCommonServiceEnvironment(env, sharedEnv),
