...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.lala.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", LALA_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.lala.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when LALA_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.lala.gateway.plist",
    },
    {
      name: "uses profile-specific label when LALA_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", LALA_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.lala.jbphoenix.plist",
    },
    {
      name: "prefers LALA_LAUNCHD_LABEL over LALA_PROFILE",
      env: {
        HOME: "/Users/test",
        LALA_PROFILE: "jbphoenix",
        LALA_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from LALA_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        LALA_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty LALA_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        LALA_PROFILE: "myprofile",
        LALA_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.lala.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
