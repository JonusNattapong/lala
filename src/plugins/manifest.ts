...
export const PLUGIN_MANIFEST_FILENAME = "lala.plugin.json";
...
// package.json "lala" metadata (used for onboarding/catalog)
...
export type LalaPackageManifest = {
  extensions?: string[];
