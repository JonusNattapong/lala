...
export type LalaPluginConfigSchema = {
...
export type LalaPluginToolContext = {
  config?: LalaConfig;
  workspaceDir?: string;
  agentDir?: string;
  agentId?: string;
...
export type LalaPluginToolFactory = (
  ctx: LalaPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type LalaPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type LalaPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<LalaConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type LalaPluginGatewayMethod = {
  method: string;
 ...
 */
export type LalaPluginCommandDefinition = {
...
export type LalaPluginHttpRouteAuth = "gateway" | "plugin";
export type LalaPluginHttpRouteMatch = "exact" | "prefix";

export type LalaPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type LalaPluginHttpRouteParams = {
  path: string;
  handler: LalaPluginHttpRouteHandler;
  auth: LalaPluginHttpRouteAuth;
  match?: LalaPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type LalaPluginCliContext = {
  program: Command;
  config: LalaConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type LalaPluginCliRegistrar = (ctx: LalaPluginCliContext) => void | Promise<void>;

export type LalaPluginServiceContext = {
  config: LalaConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type LalaPluginService = {
  id: string;
  start: (ctx: LalaPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: LalaPluginServiceContext) => void | Promise<void>;
};

export type LalaPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type LalaPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: LalaPluginConfigSchema;
  register?: (api: LalaPluginApi) => void | Promise<void>;
  activate?: (api: LalaPluginApi) => void | Promise<void>;
};

export type LalaPluginModule =
  | LalaPluginDefinition
  | ((api: LalaPluginApi) => void | Promise<void>);

export type LalaPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  registerHook: (
    ...
    opts?: LalaPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: LalaPluginHttpRouteParams) => void;
  registerChannel: (registration: LalaPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: LalaPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: LalaPluginService) => void;
   ...
   */
  registerCommand: (command: LalaPluginCommandDefinition) => void;
