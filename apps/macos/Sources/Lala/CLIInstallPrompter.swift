...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.lala", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install Lala CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .lalaSelectSettingsTab, object: tab)
        }
    }
