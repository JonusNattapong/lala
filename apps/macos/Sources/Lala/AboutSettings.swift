...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/JonusNattapong/lala") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/JonusNattapong/lala")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://lala.ai")
            ...
            Text("© 2025 Nattapong Tapachoom — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "LalaBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LalaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "LalaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LalaGitCommit") as? String) ??
            "unknown"
    }
