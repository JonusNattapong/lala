...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.lala", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".lala/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.lalaCommand(
            subcommand: "gateway",
