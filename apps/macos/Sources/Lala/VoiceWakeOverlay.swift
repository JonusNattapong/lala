...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.lala", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Lala windows, but below the system’s pop-up menus.
