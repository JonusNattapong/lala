...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.lala", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Lala/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__lala__/a2ui/").absoluteString + "?platform=macos"
    }
