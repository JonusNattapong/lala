...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .lalaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? LalaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? LalaPaths.stateDirURL.path
...
extension Notification.Name {
    static let lalaSelectSettingsTab = Notification.Name("lalaSelectSettingsTab")
}
