...
enum UIStrings {
    static let welcomeTitle = "Welcome to Lala"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "lala.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: LalaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g lala@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: LalaChatViewModel(
