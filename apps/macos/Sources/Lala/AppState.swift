...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = LalaConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = LalaConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: LalaConfigFile.loadDict(),
        ...
        LalaConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/lala"
        state.remoteCliPath = ""
        return state
    }
}
