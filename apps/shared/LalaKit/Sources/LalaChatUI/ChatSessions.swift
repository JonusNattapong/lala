...
public struct LalaChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct LalaChatSessionsDefaults: Codable, Sendable {
    public let model: String?
    public let contextTokens: Int?
}

public struct LalaChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct LalaChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: LalaChatSessionsDefaults?
    public let sessions: [LalaChatSessionEntry]
}
