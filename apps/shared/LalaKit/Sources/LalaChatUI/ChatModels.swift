...
public typealias LalaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias LalaPlatformImage = UIImage
#endif

public struct LalaChatUsageCost: Codable, Hashable, Sendable {
...
public struct LalaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: LalaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(LalaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct LalaChatMessageContent: Codable, Hashable, Sendable {
...
public struct LalaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [LalaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: LalaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [LalaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: LalaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(LalaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([LalaChatMessageContent].self, forKey: .content) {
...
public struct LalaChatHistoryPayload: Codable, Sendable {
...
public struct LalaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct LalaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [LalaSessionPreviewItem]
}

public struct LalaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [LalaSessionPreviewEntry]

    public init(ts: Int, previews: [LalaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct LalaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct LalaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct LalaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct LalaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct LalaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct LalaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: LalaPlatformImage?
...
public struct LalaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
