...
public enum LalaCanvasA2UICommand: String, Codable, Sendable {
...
public struct LalaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct LalaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
