...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: LalaProtocol.AnyCodable]?
    {
        ...
        return [
            "id": LalaProtocol.AnyCodable(identity.deviceId),
            "publicKey": LalaProtocol.AnyCodable(publicKey),
            "signature": LalaProtocol.AnyCodable(signature),
            "signedAt": LalaProtocol.AnyCodable(signedAtMs),
            "nonce": LalaProtocol.AnyCodable(nonce),
        ]
    }
}
