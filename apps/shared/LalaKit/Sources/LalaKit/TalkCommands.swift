...
public enum LalaTalkCommand: String, Codable, Sendable {
...
public struct LalaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct LalaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
