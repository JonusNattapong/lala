...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.lala.gateway"
    private static let nodeService = "ai.lala.node"
    private static let talkService = "ai.lala.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.lala.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.lala.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("lala-gateway.log")
    }
