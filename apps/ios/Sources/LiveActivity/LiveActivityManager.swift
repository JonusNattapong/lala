...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.lala.ios", category: "LiveActivity")
    private var currentActivity: Activity<LalaActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = LalaActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<LalaActivityAttributes>.activities
    ...
    private func updateCurrent(state: LalaActivityAttributes.ContentState) {
    ...
    private func connectingState() -> LalaActivityAttributes.ContentState {
        LalaActivityAttributes.ContentState(
    ...
    private func idleState() -> LalaActivityAttributes.ContentState {
        LalaActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> LalaActivityAttributes.ContentState {
        LalaActivityAttributes.ContentState(
