...
ASC_KEYCHAIN_SERVICE=lala-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.lala.client
# or
...
- The beta flow regenerates `apps/ios/Lala.xcodeproj` from `apps/ios/project.yml` before archiving
