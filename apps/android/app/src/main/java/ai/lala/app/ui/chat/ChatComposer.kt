...
import ai.lala.app.ui.mobileSurface
import ai.lala.app.ui.mobileText
import ai.lala.app.ui.mobileTextSecondary
import ai.lala.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.lala.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.lala.app.ui.mobileFontFamily,
