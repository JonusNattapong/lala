...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.lala/lala.json`
...
- The script prints a `MEDIA:` line for Lala to auto-attach on supported chat providers.
